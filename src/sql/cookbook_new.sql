-- Complete MySQL database setup script for CookBook application
-- This script includes all tables with nutrition columns integrated
...
--
-- Table structure for table `recipe` (with nutrition columns included)
--
...
--
-- Table structure for table `ingredient` (with nutrition columns included)
--
...
-- All tables include nutrition columns and sample data with nutrition values